...
const HomePage = () => {
  ...
  return (
   <div /*style={radialGradient}*/ className='h-screen radial-gradient-background aesthetic-background' >

  <Navbar/>
    
  

  <div className='text-white font-semibold mt-10 text-5xl flex justify-center items-center mono fade-in'>
          <h1>Explore the Possibilities</h1>
        </div>
        <div className='text-white font-semibold text-5xl flex justify-center items-center serif animated-text'>
          <h1>of AI Interviewing with MindMatrix</h1>
        ...
        <div className='flex  justify-center'>
          <button onClick={openModal} className='transition  shadow-lg shadow-cyan-500/50 ease-in-out delay-150 drop-shadow-md hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 mt-10 text-white p-3 rounded-tr-lg  bg-cyan-600 font-bold'>GET STARTED</button>
        </div>
